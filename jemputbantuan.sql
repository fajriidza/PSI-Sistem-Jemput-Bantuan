...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 09, 2018 at 12:28 PM
...
CREATE TABLE `bencana` (
  ...
  `deskripsi_bencana` varchar(500) COLLATE utf8_unicode_ci NOT NULL,
  `gambar` varchar(250) COLLATE utf8_unicode_ci DEFAULT NULL,
  `lokasi_id` char(4) COLLATE utf8_unicode_ci NOT NULL,
  `kebutuhan` varchar(250) COLLATE utf8_unicode_ci NOT NULL,
  `petugas_id` int(50) NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
...
INSERT INTO `bencana` (`id`, `nama_bencana`, `deskripsi_bencana`, `gambar`, `lokasi_id`, `kebutuhan`, `petugas_id`, `created_at`, `updated_at`) VALUES
(19, 'Gempa Palu', 'INI GEMPA ANO LOKAK TU', 'Screenshot_5.png', '3602', 'Sandang,Pangan', 2, '2018-12-07 05:51:55', '2018-12-07 05:51:55'),
(20, 'Tsunami', 'Bangka yayaya', 'Screenshot_7.png', '1104', 'Sandang,Pangan', 2, '2018-12-07 06:09:30', '2018-12-07 06:09:30'),
(21, 'Angin Beliung', 'Beliung ah ah', 'Screenshot_4.png', '3604', 'Sandang,Pangan', 2, '2018-12-07 07:18:43', '2018-12-07 07:18:43'),
(22, 'Banjir', 'Ini banjir loh', 'Screenshot_8.png', '1704', 'Sandang,Pangan', 2, '2018-12-07 07:19:09', '2018-12-07 07:19:09'),
(23, 'Coba lah', 'ikeh yamaete', 'Screenshot_1.png', '5102', 'Sandang', 2, '2018-12-07 07:19:28', '2018-12-07 07:19:28'),
(24, 'uhuy ayay', 'dsaads', 'Screenshot_2.png', '3403', 'Sandang', 2, '2018-12-07 07:19:41', '2018-12-07 07:19:41'),
(25, 'Gempa Palusdsd', 'erre', 'Screenshot_1.png', '3604', 'Sandang', 2, '2018-12-07 07:41:51', '2018-12-07 07:41:51'),
(27, 'Gempa Paludssd', 'sdasdasda', 'Screenshot_5.png', '1101', 'Sandang', 2, '2018-12-07 07:48:14', '2018-12-07 07:48:14'),
(28, 'coba', 'd', 'Screenshot_1.png', '5102', 'Sandang', 2, '2018-12-07 07:54:03', '2018-12-07 07:54:03'),
(29, 'ini masuk', 'assa', 'Screenshot_1.png', '3604', 'Sandang', 2, '2018-12-07 07:57:06', '2018-12-07 07:57:06'),
(30, 'alert', 'coba', 'Screenshot_1.png', '1703', 'Sandang', 2, '2018-12-07 08:02:24', '2018-12-07 08:02:24'),
(31, 'coba lagi ah', 'ssdys', 'Screenshot_2.png', '5101', 'Sandang', 2, '2018-12-07 08:03:41', '2018-12-07 08:03:41'),
(32, 'coba coyy', 'saas', 'Screenshot_1.png', '1102', 'Sandang', 2, '2018-12-07 08:05:00', '2018-12-07 08:05:00'),
(33, 'coba', 'INI GEMPA ANO LOKAK TU', 'Screenshot_1.png', '5103', 'Sandang', 2, '2018-12-07 08:09:26', '2018-12-07 08:09:26'),
(34, 'yahh', 'dded', 'Screenshot_1.png', '5102', 'Sandang', 2, '2018-12-07 08:14:02', '2018-12-07 08:14:02');
...
CREATE TABLE `donasi` (
  `id` int(150) NOT NULL,
  `nama_donasi` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `jenis_donasi` char(50) COLLATE utf8_unicode_ci NOT NULL,
  `jumlah_donasi` char(50) COLLATE utf8_unicode_ci NOT NULL,
  `lokasi_id` char(4) COLLATE utf8_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
(3, '2018_12_01_081910_create_petugas_table', 1),
(4, '2018_12_01_081921_create_admins_table', 1);
...
INSERT INTO `petugas` (`id`, `name`, `alamat`, `email`, `hp`, `password`, `remember_token`, `created_at`, `updated_at`) VALUES
(2, 'petugas', 'Jakal', 'petugas@gmail.com', '0897654', '$2y$10$8LSVz4k2rOGKGhbblFl2YeY7FhZwOoYw3m/SKuPuH01VdZS9iEcTi', NULL, '2018-12-04 00:18:39', '2018-12-04 00:18:39'),
(3, 'Fajri Idza', 'Jakal', 'ads@gmail.com', '434345', '$2y$10$LIDxRRiM9Xwmh1fmbebS1.JmFyzVbHhYfUgHvEO8MVjbBeD8uvMbW', NULL, '2018-12-04 02:54:20', '2018-12-04 02:54:20'),
(4, 'Fajri Idza Inayah', 'JAKAL', 'fajri@gmail.com', '032392', '$2y$10$6nevmqVTjhWN3Y83fqf29ucH9trDjMoE9bU7PC10BoOuguC2NSYN6', NULL, '2018-12-05 04:58:25', '2018-12-05 04:58:25');
...
CREATE TABLE `users` (
  ...
  `alamat` varchar(350) COLLATE utf8mb4_unicode_ci NOT NULL,
  `lokasi_id` varchar(7) COLLATE utf8mb4_unicode_ci NOT NULL,
  `email` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
...
(1, 'fajri', '', '', '', 'fajri@gmail.com', NULL, '$2y$10$QgRNEWDfxlInutXO1P5m0eO0IIBaa1XSP9BJENsc7a8wsgL08wv0.', 'NhKH237y5yWvWfxprh144URieNEgpl9ncEK0GgzXSWhfgD7THCXYYwrgq5Fz', '2018-12-01 02:04:11', '2018-12-01 02:04:11'),
(2, 'Fajri Idza Inayah', '09876738', 'wdwasdasdas', '1771010', 'fajri310899@gmail.com', NULL, '$2y$10$79WB2ZhvM1qtvZboVGk5j.G1/Wwm7rQM88y5.I74.ZQ2bA3LuMVZi', 'cSf0JX2jS8UrKDfxY1TrETUSPhbp5JVa3mOpcbw0U40vaYTDfXL9jB9KbrZt', '2018-12-08 22:12:43', '2018-12-08 22:12:43');
