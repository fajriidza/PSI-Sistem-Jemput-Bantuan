             ...
             <form class="" action="{{route('tambah.donasi') }}" method="post">
                ...
                <div class="col-md">
                 <label for="">Jenis Donasi</label>
                   {!! Form::select('id_jenis_donasi',[''=>'Pilih Jenis Donasi'],null,['class'=>'form-control','required']) !!}
                    ...
                    <input type="number" min="0" name="jumlah_donasi" class="form-control" placeholder="Jumlah Donasi" required>
                    </div>
                <div class="col-md">
              ...
              <div class="row">
                <div class="col-md">
                  ...
                  <input type="text" name="" value="Ditentukan Oleh LSM" class="form-control" readonly>
                  <input type="hidden" name="status" value="Menunggu" class="form-control" readonly>
                  <input type="hidden" name="lokasi_id" value="" class="form-control" readonly>
                  <input type="hidden" name="bencana_id" value="0" class="form-control" readonly>
              ...
              <div class="row">
                <div class="col-md">
                  ...
                  <input type="text" name="" value="Provinsi"class="form-control" readonly>
                </div>
                <div class="col-md">
              ...
              <div class="row">
                <div class="col-md">
                 <label for="">Kabupaten/Kota</label>
                  <input type="text" name="" value="Kabupaten"class="form-control" readonly>
                </div>
