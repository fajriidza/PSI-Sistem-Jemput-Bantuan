                    ...
                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive" cellspacing="0" width="100%">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>{{$donasi->status}}</td>
                          <td>
                            <a href="{{route('distribusi','kirim')}}" class="btn btn-success btn-xs" onclick="event.preventDefault();
                     document.getElementById('verifikasi-distribusi').submit();"><i class="fa fa-pencil"></i> Distribusi </a>
                            <form  id="verifikasi-distribusi" action="{{route('distribusi',[$donasi->id_donasi])}}" method="post">
                              {{ csrf_field() }}  
                               {{ method_field('PATCH') }} 
