        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="#" class="site_title"><i class="fa fa-cube"></i> <span>DONATE</span></a>
            </div>
                    ...
                    <!-- start project list -->
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>{{$donasi->get_dataUser['email']}}</td>
                          <td>{{$donasi->get_dataUser['no_hp']}}</td>
                          <td>{{$donasi->status}}</td>
                          <td>
                            <a href="{{route('detail.donatur',[$donasi->id_donasi])}}" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i> Detail </a>
                          </td>
                        </tr>
                        @endforeach()
                      </tbody>
